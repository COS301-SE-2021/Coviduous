...
class Bot:
    ...
    def answer_question(self, answer, question):
        ...
        if answer['score'] == 0:
            ...
            return "Woops! I'm having trouble finding the answer to your question. Please email " + self.settings[
                'help_email'] + " if I was not able to answer your question. For convenience, a google link has been generated: https://www.google.com/search?q=" + googleQuery
        else:
