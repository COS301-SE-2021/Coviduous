...
class _UserViewOfficeSpacesState extends State<UserViewOfficeSpaces> {
  ...
  Widget build(BuildContext context) {
    Widget getList() {
      if (numberOfFloors == 0) {
        //If the number of floors = 0, don't display a list
                  ...
                  ListView(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          color: Colors.white,
                          child: Text(
                              'Floors: ' + floors[index].floorNum.toString(),
                        ...
                        Container(
                          ...
                          child: Text(
                              'Number of rooms: ' +
                                  floors[index].totalNumRooms.toString(),
                              style: TextStyle(color: Colors.black)),
                        ),
                        Container(
                          height: 50,
                          ...
                          child: Text(
                              'Maximum capacity: ' +
                                  floors[index].maxCapacity.toString(),
                              style: TextStyle(color: Colors.black)),
                        ),
                        Container(
                          height: 50,
                          ...
                          child: Text(
                              'Current capacity: ' +
                                  floors[index].currentCapacity.toString(),
                              style: TextStyle(color: Colors.black)),
                        ),
                      ])
                ]),
