  ...
  Widget build(BuildContext context) {
                ...
                title: Column(
                    children:[
                      Container(
                        ...
                        color: Theme.of(context).primaryColor,
                        child: Text('Room ' + (index+1).toString(), style: TextStyle(color: Colors.white)),
                      ),
                      ListView(
                          shrinkWrap: true,
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        if (floorGlobals.globalFloors[globals.currentFloorNum].totalNumRooms > 1) { //Only allow deletion of rooms if there is more than one room
                                          floorGlobals.globalFloors[globals.currentFloorNum].totalNumRooms--;
                                          floorGlobals.globalFloors[globals.currentFloorNum].rooms.removeAt(index);
                                          setState(() {});
                                        } else {
                                          showDialog(
                                              context: context,
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text("Manage rooms for floor " + (globals.currentFloorNum + 1).toString()),
              ...
              child: Container (
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){
                      ...
                      floorGlobals.globalFloors[globals.currentFloorNum].totalNumRooms++;
                      floorGlobals.globalFloors[globals.currentFloorNum].rooms.add(new Room("", 0, 0, 0, 0, 0));
                      setState(() {});
                    },
                  )
              ),
