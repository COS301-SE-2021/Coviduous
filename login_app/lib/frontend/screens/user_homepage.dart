                      ...
                      child: Column(children: <Widget>[
                        ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).pushReplacementNamed(
                                  UserViewOfficeSpaces.routeName);
                            }),
                        SizedBox(
                          height: MediaQuery.of(context).size.height / 48,
                          width: MediaQuery.of(context).size.width,
                        ...
                        ElevatedButton(
                            ...
                            child: Row(
                                children: <Widget>[
                                  Expanded(
                                      child: Text('View current bookings')),
                            ...
                            onPressed: () {
                              Navigator.of(context).pushReplacementNamed(
                                  UserViewCurrentBookings.routeName);
                            }),
                        SizedBox(
                          height: MediaQuery.of(context).size.height / 48,
                          width: MediaQuery.of(context).size.width,
                        ...
                        ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).pushReplacementNamed(
                                  UserViewAnnouncements.routeName);
                            }),
                      ])),
                ],
              )),
