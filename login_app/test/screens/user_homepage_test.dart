...
void main() {
  ...
  testWidgets('Correct widgets appear', (WidgetTester tester) async {
    ...
    expect(find.text('View office spaces'),
        findsOneWidget); //Find one widget containing 'View office spaces'
    expect(find.text('Book office space'),
        findsOneWidget); //Find one widget containing 'Book office space'
    expect(find.text('View current bookings'),
        findsOneWidget); //Find one widget containing 'View current bookings'
