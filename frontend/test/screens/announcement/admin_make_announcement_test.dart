...
void main() {
  ...
  testWidgets('Correct widgets appear', (WidgetTester tester) async {
    ...
    expect(find.text('Select type'), findsOneWidget); //Find one widget containing 'Select announcement type'
    expect(find.text('Write your announcement'), findsOneWidget); //Find one widget containing 'Description'
